                  ...
                  {data?.map((data, idx) => {
                    return (
                      <AccordionItem
                        ...
                        value={data?.question}
                        className={cn(
                          "rounded-md transition-all duration-300 border-b border-gray-200 data-[state=open]:-mt-2 data-[state=open]:bg-white data-[state=open]:shadow-[-10px_10px_60px_-15px_rgba(0,0,0,0.5)]  data-[state=open]:p-4 data-[state=open]:rounded-xl",
