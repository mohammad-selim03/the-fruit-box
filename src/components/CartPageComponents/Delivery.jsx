...
import AddressAutoSuggest from "./AutoSuggest";
    ...
    <form onSubmit={handleSubmit(placeOrder)}>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 px-2 lg:px-[40px]">
        <div className="">
          ...
          <div className="mt-5 lg:mt-[42px] xl:mt-5 flex flex-col gap-[26px]">
        ...
        <div>
          ...
          <div className="mt-5 md:mt-[40px] flex flex-col gap-3 md:gap-[26px]">
